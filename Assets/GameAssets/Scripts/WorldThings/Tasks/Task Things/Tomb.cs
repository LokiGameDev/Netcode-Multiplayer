...
/// <summary>Represents the networked opened-tomb closing task.</summary>
public class Tomb : NetworkBehaviour, ITask
{
    /// <summary>Gets the task category.</summary>
    public TaskType taskType => TaskType.CloseTheOpenedTomb;
    ...
    [Tooltip("Action label shown while the tomb can be closed.")]
    ...
    /// <summary>Marks the tomb task complete.</summary>
    ...
    /// <summary>Starts the tomb task UI when the task is incomplete.</summary>
    ...
    /// <summary>Returns the tomb transform used for interaction.</summary>
