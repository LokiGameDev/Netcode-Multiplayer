...
/// <summary>Represents the networked broken-tomb repair task.</summary>
public class BrokenTomb : NetworkBehaviour, ITask
{
    ...
    [Tooltip("Action label shown while the tomb can be rebuilt.")]
    ...
    /// <summary>Marks the broken-tomb task complete.</summary>
